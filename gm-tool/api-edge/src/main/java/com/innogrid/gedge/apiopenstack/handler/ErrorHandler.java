package com.innogrid.gedge.apiopenstack.handler;
...
//    }
    ...
    private Map<String, Object> translate(Throwable e) {
        ...
        if(e instanceof AccessDeniedException || e instanceof GedgeplatformUnAuthorizedException) {
            ...
            detail = e.getMessage();
            type = "4100";
        } else if(e instanceof NumberFormatException || e instanceof NullPointerException || e instanceof IllegalArgumentException) {
            title = e.getMessage();
            detail = e.getMessage();
            type = "4102";
        } else {
