(function($){
    ...
    */
	...
	function render(options) {
        ...
        var beforeHtml = '<button type="button" class="pagenation_btn first" title="First page" data-page="first"><span>First</span></button><button type="button" class="pagenation_btn prev" title="Previous" data-page="before"><span>Prev</span></button>';
        var nextHtml = '<button type="button" class="pagenation_btn next" title="Next" data-page="next"><span>Next</span></button><button type="button" class="pagenation_btn last" title="Last page" data-page="last"><span>Last</span></button>';
        var currentHtml = '<div class="pagenation_current"><strong class="current">{{=from}} - {{=to}}</strong>of<span class="total">{{=records}}</span></div>';

		if(options){

			options.el.empty();
			root.append(beforeHtml);
