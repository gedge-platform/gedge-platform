    ...
    <>
      <div className="div-content-detail">
        ...
        <div className="resource-content-1">
          <div className="resource-text-1 ">디플로이먼트</div>
        </div>
        <div className="resource-content-1">
          <div className="resource-text-1 ">44</div>
        </div>
      </div>
      <div className="div-content-detail">
        <div style={{ width: "40px" }}>
        ...
        <div className="resource-content-1">
          <div className="resource-text-1 ">파드</div>
        </div>
        <div className="resource-content-1">
          <div className="resource-text-1 ">35</div>
        </div>
      </div>
      <div className="div-content-detail">
        <div style={{ width: "40px" }}>
        ...
        <div className="resource-content-1">
          <div className="resource-text-1 ">서비스</div>
        </div>
        <div className="resource-content-1">
          <div className="resource-text-1 ">14</div>
        </div>
      </div>
      <div className="div-content-detail">
        <div style={{ width: "40px" }}>
        ...
        <div className="resource-content-1">
          <div className="resource-text-1 ">크론잡</div>
        </div>
        <div className="resource-content-1">
          <div className="resource-text-1 ">0</div>
        </div>
      </div>
      <div className="div-content-detail">
        <div style={{ width: "40px" }}>
        ...
        <div className="resource-content-1">
          <div className="resource-text-1 ">잡</div>
        </div>
        <div className="resource-content-1">
          <div className="resource-text-1 ">1</div>
        </div>
      </div>
      <div className="div-content-detail">
        <div style={{ width: "40px" }}>
        ...
        <div className="resource-content-1">
          <div className="resource-text-1 ">볼륨</div>
        </div>
        <div className="resource-content-1">
          <div className="resource-text-1 ">2</div>
        </div>
      </div>
    </>
  );
