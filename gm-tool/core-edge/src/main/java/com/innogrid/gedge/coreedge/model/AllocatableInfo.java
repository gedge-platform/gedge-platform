 ...
 */
@Data
public class AllocatableInfo implements Serializable {
    ...
    @Key @JsonString private Integer usingPods;
    @Key @JsonString private String usingCpu;
    @Key @JsonString private String usingMemory;

    public AllocatableInfo(){}
}
