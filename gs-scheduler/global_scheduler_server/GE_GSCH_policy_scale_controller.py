...
class policyScaleController:
    ...
    def get_policy_name_list(self):
        return self.support_policy_list
    
    def get_replica_size_by_policy_name(self,policy_name):
        try :
            result = self.support_policy_dic[policy_name]    
        except :
            print('error : get_replica_size_by_policy_name')
            return False
        return result
