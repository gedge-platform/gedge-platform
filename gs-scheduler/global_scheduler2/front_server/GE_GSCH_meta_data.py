...
class metaData:
    def __init__(self, ip='localhost', port=27017):
        ...
        self.front_db = self.client[gDefine.MONGO_DB_NAME_FRONT_SERVER]
        self.front_services_col = self.front_db[gDefine.MONGO_DB_COLLECTION_FRONT_SERVER_SERVICES]
        self.cluster_db = self.client[gDefine.MONGO_DB_NAME_CLUSTER_INFO]
        self.cluster_col = self.front_db[gDefine.MONGO_DB_COLLECTION_CLUSTER_INFO]
