...
if __name__ == '__main__':
    ...
    for i in range(1,10):
        ...
        change_str_list.append(
            ["SERVICE-NAME", "get-hostname-service-"+str(i)])
        change_str_list.append(["POD-NAME", "get-hostname-"+str(i)])

        service_pod_list.append(
            ["get-hostname-service-" + str(i), "get-hostname-"+str(i)])

        replace_str_in_file("get-hostname-normal-templete.yaml",
                            "get-hostname-"+str(i)+".yaml", change_str_list)
