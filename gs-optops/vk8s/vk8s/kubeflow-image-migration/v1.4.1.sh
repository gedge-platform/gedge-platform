#!/bin/bash
if [ $# -ne 1 ]; then
  echo "Usage: ./v1.4.1.sh <image-registry>"
  exit -1
fi
...
1.7.0
1.7.0
v3.1.6-patch-license-compliance
1.0.0 )
...
sudo docker push ${registry}/${images[$i]}:${tags[$i]};  # sudo docker push 10.40.103.111:15001/${images[$i]}:${tags[$i]}; 
done
...
sha256:edf462d03591e53e536640591a53538e6bea837fea15ed081eccfb42bc35a5c0 )
